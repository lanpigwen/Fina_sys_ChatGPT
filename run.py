...
sessions={}
#region
way_to_respond="""在用户发给你某些公司的年报后，对你发出分析公司年报的请求，请你根据以下的用户发你的年报，用Fina888分析法，只构造Fina888分析法中指定的五个指标来进行综合打分，无需详细步骤，只需给出各个公司最终的综合得分以及这五个指标的值以及权重，然后对综合评分的结果以及影响综合得分的指标(如Fina888指定的五个指标)稍微做出一些分析，并且针对这些方面给对应企业一些可行性建议，如果你需要计算的时间比较长，可以先询问用户，能不能稍等一下"""
